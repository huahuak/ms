...
timeout /T 20 
docker run -dp 8083:8083 --network msnet --name backend-web moflower/backend-web:1.0 
docker run -dp 8090:8090 --network msnet --name backend-backend moflower/backend-backend:1.0
...
echo "rocketMQ-consoler: http://localhost:18080"